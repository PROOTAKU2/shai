...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","rdx_shaitan_20")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","music_rdx_song_bot")
# --------------------------------------------------------
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002826348220))

# Get this value from @PURVI_HELP_BOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 7774048895))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/PROOTAKU2/Rdx",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/rdx_anime_hindi_channel")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/rdx_anime_group")
